const CACHE='opensource-explorer-v3';
const CORE=['./','./index.html','./styles.css','./app.js','./detail.js','./enhancements.js','./catalog-bootstrap.js','./analytics.js','./v9.js','./manifest.webmanifest','./icon.svg','./data/catalog.json'];
