const CACHE='opensource-explorer-v5';
const CORE=['./','./index.html','./tool.html','./styles.css','./app.js','./detail.js','./enhancements.js','./catalog-bootstrap.js','./analytics.js','./v12.js','./manifest.webmanifest','./icon.svg','./data/catalog.json'];
