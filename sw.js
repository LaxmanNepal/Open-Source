const CACHE='opensource-explorer-v1';
const CORE=['./','./index.html','./styles.css','./app.js','./detail.js','./enhancements.js','./catalog-bootstrap.js','./manifest.webmanifest','./icon.svg'];
