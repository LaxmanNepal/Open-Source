const CACHE='opensource-explorer-v2';
const CORE=['./','./index.html','./styles.css','./app.js','./detail.js','./enhancements.js','./catalog-bootstrap.js','./analytics.js','./manifest.webmanifest','./icon.svg','./data/catalog.json'];
